          ...
          <IonRow className="ion-justify-content-center ion-align-items-center">
            <IonCol sizeXs='12' sizeMd='8' sizeLg='6' sizeXl='4'>
              <div className='ion-text-center'>
                <img src={LOTUS_WOMAN} alt='Mujer haciendo la postura de lotus de yoga' width='90%' />
              </div>
            </IonCol>
          </IonRow>
              ...
              <IonCard color='primary' className='menu-card'>
                <IonCardContent>
                  <div className='ion-text-center'>
                    ...
                    <IonButton color='secondary' size='large' expand='block' href={GLOBAL.ROUTES.BOOKINGS}>
